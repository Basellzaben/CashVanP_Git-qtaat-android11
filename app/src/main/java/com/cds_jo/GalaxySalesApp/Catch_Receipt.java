...
*/
        ...
        InsertLogTrans obj=new InsertLogTrans(Catch_Receipt.this,SCR_NO , SCR_ACTIONS.open.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"");
    ...
    public void Save_Recod_Po() {
        ...
        alertDialog.setTitle("سند القبض");
        if (i > 0) {
            InsertLogTrans obj=new InsertLogTrans(Catch_Receipt.this,SCR_NO , SCR_ACTIONS.Insert.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"");
...
/*
    ...
    public void btn_print(View view) {
        InsertLogTrans obj=new InsertLogTrans(Catch_Receipt.this,SCR_NO , SCR_ACTIONS.Print.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"");
    ...
    public void btn_share(View view) {
        InsertLogTrans obj=new InsertLogTrans(Catch_Receipt.this,SCR_NO , SCR_ACTIONS.Share.getValue(),et_OrdeNo.getText().toString(),tv_acc.getText().toString(),"");

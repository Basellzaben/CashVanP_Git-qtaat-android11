...
// DoctorReport  "( ID ,VType ,No,CustNo ,LocatNo , Sp1 , SampleType  , VNotes ,SNotes  ,Tr_Date , Tr_Time   ,UserNo , Posted
    ...
    public void btn_share(View view) {
        ...
        if(IsNew==true){
            AlertDialog alertDialog = new AlertDialog.Builder(
                    this).create();
            alertDialog.setTitle("تقرير الاطباء");
       ...
       String query = "  select distinct  ID ,VType ,No,CustNo ,LocatNo , Sp1 , SampleType  , VNotes ,SNotes  ,Tr_Date , Tr_Time   ,UserNo , Posted from DoctorReport   " +
        ...
        loadingdialog = ProgressDialog.show(DoctorReportActivity.this, "الرجاء الانتظار ...", "الرجاء الانتظار .... العمل جاري على اعتماد الزيارة", true);
                    ...
                    if (We_Result.ID > 0) {
                        ...
                        _handler.post(new Runnable() {
                            public void run() {
                                ...
                                alertDialog.setTitle(" اعتماد  تقرير الزيارة");
                                alertDialog.setMessage("تمت عملية اعتماد الزيارة بنجاح");
    ...
    public void ShowRecord() {
        ...
        String q = "Select distinct Customers.name  as Name,  DoctorReport.ID ,VType ,DoctorReport.No,CustNo ,LocatNo , Sp1 , SampleType  , VNotes ,SNotes  ,Tr_Date , Tr_Time   ,UserNo , COALESCE(DoctorReport.Posted, -1)  as Post  from DoctorReport left join Customers  on Customers.no =DoctorReport.CustNo" +
    ...
    public void btn_delete(View view) {
        ...
        alertDialog.setTitle("حذف تقرر الاطباء");
...
// DoctorReport  "( ID ,VType ,No,CustNo ,LocatNo , Sp1 , SampleType  , VNotes ,SNotes  ,Tr_Date , Tr_Time   ,UserNo , Posted
        ...
        alertDialog = new AlertDialog.Builder(
                this).create();
             alertDialog.setTitle("نموذج طلب عينات / تقرير الاطباء");
        if (i > 0) {
    ...
    public void btn_save_po(View view) {
        ...
        alert_Dialog.setTitle("تقرير الاطباء");
